...
def main():
    ...
    predictions.to_csv("results/mcnemar_predictions.csv", index=False)
    ...
    results_df.to_csv("results/mcnemar_results.csv", index=False)
    ...
    print("\nSaved:")
    print("results/mcnemar_predictions.csv")
    print("results/mcnemar_results.csv")
