"""
Strict cross-subject Autoencoder + RBF-SVM LOSO evaluation.
...
For every LOSO fold:
    training subjects
        -> train autoencoder
        -> fit training-only EEG standardizer
        -> extract latent features
        -> train RBF-SVM

    held-out subject
        -> apply same training standardizer
        -> same frozen encoder
        -> RBF-SVM prediction
...
Run:
    python -m scripts.cross_subject.run_autoencoder_rbf_svm
"""
...
SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_rbf_svm_loso_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_rbf_svm_loso_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_rbf_svm_loso_overall_summary.csv"
)
