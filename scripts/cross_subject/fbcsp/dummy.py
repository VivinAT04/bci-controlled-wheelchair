"""
Cross-subject FBCSP + Dummy evaluation.
...
Run:
    python -m scripts.cross_subject.fbcsp.dummy
"""
...
RESULTS_DIRECTORY = Path(
    "results/cross_subject/fbcsp_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_subject_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_subject_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_subject_overall_summary.csv"
)
