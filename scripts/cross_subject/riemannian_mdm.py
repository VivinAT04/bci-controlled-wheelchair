"""
Cross-subject Riemannian MDM evaluation.
...
Run:
    python -m scripts.cross_subject.riemannian_mdm
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "riemannian_mdm_cross_subject_overall_summary.csv"
)
...
def build_overall_summary(
    ...
    """Calculate overall nine-subject statistics."""
...
def main() -> None:
    """Run cross-subject Riemannian MDM."""

    print()
    print("=" * 78)

    print(
        "Cross-Subject Riemannian MDM"
    )
