"""
Cross-subject FBCSP + RBF-SVM evaluation.
...
Run:
    python -m scripts.cross_subject.fbcsp_rbf_svm
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_rbf_svm_cross_subject_overall_summary.csv"
)
...
def load_all_data():
    ...
    print()
    print("=" * 78)
    print("LOADING CROSS-SUBJECT FBCSP DATA")
    print("=" * 78)
