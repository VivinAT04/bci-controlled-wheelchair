...
Run:
    python -m scripts.cross_subject.riemannian_tangent_lda
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "riemannian_tangent_lda_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """
    Run nine-fold cross-subject Tangent-Space + LDA.
    """
