"""
Strict Leave-One-Subject-Out cross-subject evaluation using FBCSP + RBF-SVM.
...
Run from the project root:
    ...
    python -m scripts.cross_subject.run_fbcsp_svm
"""
...
SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "cross_subject_fbcsp_svm_loso_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "cross_subject_fbcsp_svm_loso_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "cross_subject_fbcsp_svm_loso_overall_summary.csv"
)


def load_all_subjects() -> dict[str, dict[str, np.ndarray]]:
    """Load broadband processed EEG for all subjects."""

    subject_data = {}

    print("=" * 78)
    print("Loading 4-40 Hz processed EEG data")
    print("=" * 78)
...
def get_training_data(
    ...
    """Pool all subjects except the held-out test subject."""
...
def main() -> None:
    """Run strict FBCSP + RBF-SVM LOSO evaluation."""

    print()
    print("=" * 78)
    print("Strict Cross-Subject FBCSP + RBF-SVM")
    print("=" * 78)
    ...
    print()
    print("=" * 78)
    print("FINAL FBCSP + RBF-SVM LOSO RESULTS")
    print("=" * 78)
