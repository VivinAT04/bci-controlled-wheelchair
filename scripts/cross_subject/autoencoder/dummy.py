"""
Cross-subject Autoencoder + Dummy evaluation.
...
Run:
    python -m scripts.cross_subject.autoencoder.dummy
"""
...
RESULTS_DIRECTORY = Path(
    "results/cross_subject/autoencoder_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_subject_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_subject_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Autoencoder + Dummy."""
    ...
    for fold_number, held_out_subject in enumerate(
        ...
        # -----------------------------------------------------
        # 5. TRAIN Dummy ON TRAINING FEATURES ONLY
        # -----------------------------------------------------
