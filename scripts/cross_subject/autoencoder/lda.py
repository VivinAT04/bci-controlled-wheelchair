"""
Cross-subject Autoencoder + LDA evaluation.
...
Run:
    python -m scripts.cross_subject.autoencoder.lda
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_lda_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Autoencoder + LDA."""
    ...
    for fold_number, held_out_subject in enumerate(
        ...
        # -----------------------------------------------------
        # 5. TRAIN LDA ON TRAINING FEATURES ONLY
        # -----------------------------------------------------
