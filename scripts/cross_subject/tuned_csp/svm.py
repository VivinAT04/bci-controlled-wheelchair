"""
Cross-subject Tuned CSP + RBF-SVM evaluation.
...
Run:
    python -m scripts.cross_subject.tuned_csp.svm
"""
...
from bci_wheelchair.models import make_tuned_csp_svm
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_rbf_svm_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Tuned CSP + RBF-SVM."""

    print()
    print("=" * 78)

    print(
        "Cross-Subject Tuned CSP + RBF-SVM"
    )
