"""
Cross-subject Tuned CSP + LDA evaluation.
...
Run:
    python -m scripts.cross_subject.tuned_csp.lda
"""
...
from bci_wheelchair.models import make_tuned_csp_lda
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_lda_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Tuned CSP + LDA."""

    print()
    print("=" * 78)

    print(
        "Cross-Subject Tuned CSP + LDA"
    )
