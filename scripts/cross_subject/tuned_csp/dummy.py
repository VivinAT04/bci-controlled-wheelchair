"""
Cross-subject Tuned CSP + Dummy evaluation.
...
Run:
    python -m scripts.cross_subject.tuned_csp.dummy
"""
...
RESULTS_DIRECTORY = Path(
    "results/cross_subject/tuned_csp_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_dummy_cross_subject_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_dummy_cross_subject_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_dummy_cross_subject_overall_summary.csv"
)
...
def load_all_data():
    """
    Load T and E sessions separately.

    T sessions are available only for training.
    E sessions are available only for held-out testing.
    """
...
def create_cross_subject_fold(
    ...
    """
    Create one cross-subject fold.

    Training:
        all T sessions except held-out subject T
...
def build_prediction_rows(
    ...
    """Create trial-level held-out E predictions."""
...
def build_overall_summary(
    ...
    """Calculate overall statistics across nine E sessions."""
...
def main() -> None:
    """Run cross-subject Tuned CSP + Dummy."""

    print()
    print("=" * 78)

    print(
        "Cross-Subject Tuned CSP + Dummy"
    )
