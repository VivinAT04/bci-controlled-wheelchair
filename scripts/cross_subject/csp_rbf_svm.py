"""
Cross-subject CSP + RBF-SVM evaluation.
...
Run:
    python -m scripts.cross_subject.csp_rbf_svm
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "csp_rbf_svm_cross_subject_overall_summary.csv"
)
...
def load_all_data():
    ...
    T sessions are used only as candidate training data.
...
def create_cross_subject_fold(
    ...
    Train on T sessions from all other subjects.
...
def main() -> None:
    """Run all nine cross-subject CSP + RBF-SVM folds."""

    print()
    print("=" * 78)
    print(
        "Cross-Subject CSP + RBF-SVM"
    )
    print("=" * 78)
