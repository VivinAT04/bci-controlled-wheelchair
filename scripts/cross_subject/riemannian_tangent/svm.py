...
Run:
    python -m scripts.cross_subject.riemannian_tangent.svm
"""
...
from bci_wheelchair.models import make_tangent_svm
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "riemannian_tangent_rbf_svm_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """
    Run nine-fold cross-subject Tangent-Space + RBF-SVM.
    """
