"""
Cross-subject Supervised Autoencoder + LDA evaluation.
...
Run:
    python -m scripts.cross_subject.supervised_autoencoder.lda
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "supervised_autoencoder_lda_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Supervised Autoencoder + LDA."""
    ...
    print(
        "FINAL CROSS-SUBJECT "
        "SUPERVISED AUTOENCODER + LDA RESULTS"
    )
