"""
Cross-subject EA + CSP + LDA evaluation.
...
Held-out E session
    ...
    -> fitted CSP/classifier
    -> prediction

No labels from the held-out E session are used during training.

Run:
    python -m scripts.cross_subject.euclidean_alignment.csp.dummy
"""
...
RESULTS_DIRECTORY = Path(
    "results/cross_subject/euclidean_alignment/csp/dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "ea_csp_dummy_cross_subject_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "ea_csp_dummy_cross_subject_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "ea_csp_dummy_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    ...
    for fold_number, held_out_subject in enumerate(
        ...
        # -----------------------------------------------------
        # PCA INFO
        # CSP pipelines do not use PCA.
        retained_pca_components = None
