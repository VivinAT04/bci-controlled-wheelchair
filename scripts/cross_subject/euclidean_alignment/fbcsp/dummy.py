...
Run:
    python -m scripts.cross_subject.euclidean_alignment.fbcsp.dummy
"""
...
RESULTS_DIRECTORY = Path(
    "results/cross_subject/euclidean_alignment/fbcsp/dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_subject_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_subject_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_subject_overall_summary.csv"
)
