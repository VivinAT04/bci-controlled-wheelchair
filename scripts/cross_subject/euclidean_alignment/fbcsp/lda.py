...
Run:
    python -m scripts.cross_subject.euclidean_alignment.fbcsp.lda
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_lda_cross_subject_overall_summary.csv"
)
