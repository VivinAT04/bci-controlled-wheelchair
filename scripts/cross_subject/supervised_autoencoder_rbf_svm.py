"""
Cross-subject Supervised Autoencoder + RBF-SVM evaluation.
...
Run:
    python -m scripts.cross_subject.supervised_autoencoder_rbf_svm
"""
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "supervised_autoencoder_rbf_svm_cross_subject_overall_summary.csv"
)
...
def main() -> None:
    """Run cross-subject Supervised Autoencoder + RBF-SVM."""
    ...
    print(
        "FINAL CROSS-SUBJECT "
        "SUPERVISED AUTOENCODER + RBF-SVM RESULTS"
    )
