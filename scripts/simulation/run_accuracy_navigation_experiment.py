...
scripts.simulation.interactive_grid_size_demo.

Run:
    python -m scripts.simulation.run_accuracy_navigation_experiment
"""
...
from scripts.simulation.interactive_grid_size_demo import (
    apply_command,
...
OUTPUT_DIRECTORY = Path(
    "results/simulation/navigation/accuracy_navigation_analysis"
)
