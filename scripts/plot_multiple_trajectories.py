...
PREDICTIONS_PATH = Path("results/test_predicted_commands.csv")
OUTPUT_DIRECTORY = Path("results/trajectory_figures")
TRAJECTORY_DATA_PATH = Path(
    "results/multiple_trajectory_data.csv"
)
...
def main() -> None:
    ...
    if not PREDICTIONS_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run `python -m scripts.export_predictions` first."
        )
