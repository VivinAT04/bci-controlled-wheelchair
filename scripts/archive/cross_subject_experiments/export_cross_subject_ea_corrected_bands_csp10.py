...
OUTPUT_PATH = Path(
    "results/cross_subject/csp_fbcsp/cross_subject_a09_ea_corrected_bands_csp10_predictions.csv"
)

SUMMARY_PATH = Path(
    "results/cross_subject/csp_fbcsp/cross_subject_a09_ea_corrected_bands_csp10_summary.csv"
)
...
def main() -> None:
    ...
    print("\n" + "=" * 76)
    print(
        "EA Corrected-Band CSP-10 Cross-Subject Results"
    )
    print("=" * 76)
