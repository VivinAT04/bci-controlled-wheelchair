...
OUTPUT_PATH = Path(
    "results/cross_subject/csp_fbcsp/cross_subject_a09_ea_csp10_pca99_predictions.csv"
)

SUMMARY_PATH = Path(
    "results/cross_subject/csp_fbcsp/cross_subject_a09_ea_csp10_pca99_summary.csv"
)
...
def make_ea_regularized_classifier() -> Pipeline:
    """
    Build regularized FBCSP followed by PCA (99% retained variance) and shrinkage LDA.
