...
Run:
    python -m scripts.within_subject.export_test_predictions
"""
...
from bci_wheelchair.data.preprocessing import LABEL_MAP, preprocess_raw
...
OUTPUT_PATH = Path("results/within_subject/predictions/test_predicted_commands.csv")
