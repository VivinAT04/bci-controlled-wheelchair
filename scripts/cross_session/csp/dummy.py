...
RESULTS_DIRECTORY = Path(
    "results/cross_session/csp_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "csp_dummy_cross_session_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "csp_dummy_cross_session_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "csp_dummy_cross_session_overall_summary.csv"
)
...
def calculate_subject_result(
    ...
    """Calculate metrics for one evaluation subject."""
...
def main() -> None:
    ...
    # ---------------------------------------------------------
    # 1. LOAD AND POOL ALL TRAINING SESSIONS
    # ---------------------------------------------------------
