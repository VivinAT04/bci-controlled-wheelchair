...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "csp_rbf_svm_cross_session_overall_summary.csv"
)
...
def load_pooled_training_data() -> tuple[
    ...
    """Load and concatenate A01T-A09T training trials."""
...
def main() -> None:
    """Run pooled cross-session CSP + RBF-SVM."""
