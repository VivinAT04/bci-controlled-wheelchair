...
RESULTS_DIRECTORY = Path(
    "results/cross_session/riemannian/filterbank/dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "filterbank_riemannian_dummy_cross_session_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "filterbank_riemannian_dummy_cross_session_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "filterbank_riemannian_dummy_cross_session_overall_summary.csv"
)
...
def build_overall_summary(
    ...
    return {
        "model": "FilterBank_Riemannian_Dummy",
        "evaluation": (
            "cross_session_pooled_training_all_evaluation_sessions"
        ),
        "training_sessions": (
