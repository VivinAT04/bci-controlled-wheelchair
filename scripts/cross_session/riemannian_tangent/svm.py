...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "tangent_rbf_svm_cross_session_overall_summary.csv"
)
...
def build_overall_summary(
    ...
    return {
        "model": "Riemannian_Tangent_RBF_SVM",
        "evaluation": (
            "cross_session_pooled_training_all_evaluation_sessions"
        ),
        "training_sessions": (
...
def main() -> None:
    """Run pooled cross-session Tangent-Space + RBF-SVM."""
