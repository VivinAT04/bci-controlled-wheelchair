...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "tuned_csp_rbf_svm_cross_session_overall_summary.csv"
)
...
def main() -> None:
    """Run supervisor Method 1 Tuned CSP + RBF-SVM."""
    ...
    print(
        "Training one pooled "
        "Tuned CSP + RBF-SVM model..."
    )

    classifier = make_tuned_csp_svm()
