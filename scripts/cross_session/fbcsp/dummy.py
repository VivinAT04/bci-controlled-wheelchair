"""
Cross-session evaluation using FBCSP + Dummy.
...
from bci_wheelchair.models.fbcsp import DEFAULT_BANDS
from bci_wheelchair.models import make_fbcsp_dummy
...
RESULTS_DIRECTORY = Path(
    "results/cross_session/fbcsp_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_session_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_session_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "fbcsp_dummy_cross_session_overall_summary.csv"
)
...
def calculate_subject_result(
    ...
    result = {
        ...
        "filterbank_bands": str(DEFAULT_BANDS),
        ...
        "left_hand_recall": float(recalls[0]),
        "right_hand_recall": float(recalls[1]),
        "feet_recall": float(recalls[2]),
        "tongue_recall": float(recalls[3]),
...
def main() -> None:
    """Run pooled cross-session FBCSP + Dummy."""
