"""
Cross-session Autoencoder + LDA evaluation.
...
OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_lda_cross_session_overall_summary.csv"
)
...
def main() -> None:
    """Run pooled cross-session Autoencoder + LDA."""
