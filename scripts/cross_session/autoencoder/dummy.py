"""
Cross-session Autoencoder + Dummy evaluation.

Protocol
--------
Train using pooled training-session data:

    A01T + A02T + ... + A09T

The autoencoder is trained once using only pooled T-session data.

Latent features are extracted from the pooled training data and
used to train one RBF-SVM classifier.

The same trained autoencoder, standardiser, and RBF-SVM are then
...
No evaluation-session data are used for:
...
RESULTS_DIRECTORY = Path(
    "results/cross_session/autoencoder_dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_session_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_session_predictions.csv"
)

OVERALL_SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "autoencoder_dummy_cross_session_overall_summary.csv"
)
...
def build_overall_summary(
    ...
    """Calculate mean performance across A01E-A09E."""
...
def main() -> None:
    """Run pooled cross-session Autoencoder + Dummy."""
    ...
    print(
        "TRAINING ONE POOLED AUTOENCODER"
    )
    ...
    # ---------------------------------------------------------
    # 3. EXTRACT POOLED TRAINING FEATURES
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 5. TEST SAME PIPELINE ON A01E-A09E
    # ---------------------------------------------------------
