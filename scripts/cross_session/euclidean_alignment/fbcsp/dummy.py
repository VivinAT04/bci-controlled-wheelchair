...
RESULTS_DIRECTORY = Path(
    "results/cross_session/euclidean_alignment/fbcsp/dummy"
)

SUBJECT_RESULTS_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_session_subject_results.csv"
)

PREDICTIONS_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_session_predictions.csv"
)

SUMMARY_PATH = (
    RESULTS_DIRECTORY
    / "ea_fbcsp_dummy_cross_session_overall_summary.csv"
)
